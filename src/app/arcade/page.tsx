  ...
  return (
    <div className="pt-1">
      ...
      <PhaseNote className="mt-6">
        {rewardsReady
          ? 'Every finished round is banked to your withdrawable balance automatically. Coins are worth 0.2 NIM each, hazards cost you 0.5, and your score itself earns as it climbs — the further you get, the more the round pays, with no ceiling on a round or on a day. Withdrawals are capped at 100 NIM a day; anything above that waits on your balance for tomorrow.'
