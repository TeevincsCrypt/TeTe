  ...
  return (
    <div className="pt-1">
      ...
      <PhaseNote className="mt-6">
        {rewardsReady
          ? 'Every finished round is banked to your withdrawable balance automatically. Coins are worth 0.001 NIM each, hazards cost you 0.2, and your score itself earns as it climbs — the further you get, the more the round pays, up to 20 NIM in a single round. There is no limit on how many rounds you play. Withdrawals are capped at 100 NIM a day; anything above that waits on your balance for tomorrow.'
